...
type Props = ButtonHTMLAttributes<HTMLButtonElement> & { variant?: "default" | "secondary"; size?: "sm" | "md" | "lg"; className?: string; };
export function Button({ variant="default", size="md", className, ...props }: Props) {
  ...
  const variants = { default: "bg-emerald-600 text-white hover:bg-emerald-500", secondary: "bg-white/10 text-white hover:bg-white/20" } as const;
